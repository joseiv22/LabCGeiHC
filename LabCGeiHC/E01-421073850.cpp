...
//Color primera figura
static const char* fShader = "						\n\
#version 330										\n\
out vec4 color;										\n\
void main()											\n\
{													\n\
	color = vec4(0.85f,0.09f,0.35f,1.0f);	 			\n\
}";
// vec4(1.0f,0.0f,0.0f,1.0f); Rojo
// vec4(1.0f,0.5f,0.0f,1.0f); Naranja
// Para obtener colores aqui el rgb lo dividimos entre 255 y nos da valores para vec4(0.85f,0.09f,0.35f,1.0f);
