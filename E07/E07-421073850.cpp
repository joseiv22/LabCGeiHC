...
int main()
{
	...
	mainLight = DirectionalLight(1.0f, 1.0f, 1.0f,
		// intensidad ambiental la distancia maxima ilumina del centro y difusa
		0.3f, 0.3f,
		0.0f, 0.0f, -1.0f);
	...
	//linterna
	// EL primer vector cambia el color
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 lightPosition = glm::vec3(-4.0f + mainWindow.getmuevex(), 3.0f, -4.0f);
