...
int main()
{
	...
	*/
	...
	glm::mat4 modelbaseaux(1.0);//Inicializar matriz de Modelo 4x4
	...
	while (!mainWindow.getShouldClose())
	{
		...
		sp.render(); //dibuja esfera
		//----------------------------------------------------------------------------------------
		//Creando el tercer brazo de la grúa
		model = modelaux;
		...
		modelbaseaux = model;
		model = glm::scale(model, glm::vec3(4.0f, 1.8f, 2.8f));
		...
		// Llantas
		model = modelbaseaux;
		model = glm::translate(model, glm::vec3(1.8f, -1.2f, 2.0f));
